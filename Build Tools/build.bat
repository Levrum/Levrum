...
call ant -f ant-build-script.xml -Denv.SVN_REVISION_1=9999 update-version-number
...
call ant -f ant-build-script.xml -Denv.SVN_REVISION_1=9999 build-installer-local
